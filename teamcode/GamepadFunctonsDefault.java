...
public class GamepadFunctonsDefault extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sweeper = hardwareMap.get(DcMotor.class, "intake");
        armExtend = hardwareMap.get(DcMotor.class, "aExt");
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.a && !isAOn) {
                ...
                if (slowModeValue == 1.0) slowModeValue = .3;
            ...
            boxJoint.setPosition(gamepad2.left_stick_y);
            if (gamepad2.x) {
           ...
           if (gamepad2.dpad_up) {
               boxJoint.getController().pwmDisable();
           }
