...
@Autonomous(name = "ZerosOneMarkerAutonomous", group = "Autonomous")
public class ZerosOneMarkerAutonomous extends Nav_Routines {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //zno winchup();
        winchdown();
        //IN winchDown add a part that makes it face forwards auto.
        goldfound = checktfod();
        if (!goldfound) {
            ...
            //go_sideways(270, 0, .3, 5); // Confirmed for right side
            go_sideways(90, 0, 1, 43);
