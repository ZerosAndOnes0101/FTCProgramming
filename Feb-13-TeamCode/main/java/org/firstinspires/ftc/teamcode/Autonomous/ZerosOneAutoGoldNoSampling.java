...
@Autonomous(name = "ZerosOneAutoGoldNoSampling", group = "Autonomous")
public class ZerosOneAutoGoldNoSampling extends Nav_Routines {
   ...
   // int leftrightcenter = 1; // 1 = left,  2 = right, 3= center
    ...
    public void runOpMode() throws InterruptedException {
       ...
       // initVuforiaImage();
        ...
        go_sideways(180, 0, .5, 10); // forward


       /* go_sideways(180, 0, .5, 7); // forward
        sleep(200);*/
        //goRight();
      /* No Sampling  go_sideways(180, 0, .5, 7); // Step2
        sleep(100);
